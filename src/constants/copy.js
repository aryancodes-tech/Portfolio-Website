/**
 * Short copy strings reused across the portfolio.
 */
 ...
 * @type {string}
 */
export const BLOG_EMPTY_SEARCH_TITLE = 'Nothing matched your search'
 ...
 * @type {string}
 */
export const BLOG_EMPTY_SEARCH_CLEAR_LABEL = 'Clear search'

/**
 * Title when no posts are published on the blog index.
 * @type {string}
 */
export const BLOG_EMPTY_CATALOG_TITLE = 'No posts published yet'
