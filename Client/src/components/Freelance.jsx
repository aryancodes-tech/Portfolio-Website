...
const Freelance = () => {
  ...
  return (
    <div className="font-['Gilroy'] p-5 w-full flex flex-col gap-5">
      <span className="text-4xl font-bold flex flex-row gap-2 items-center">
          ...
          {(!isPlaying || (isHovered && isOverlayVisible)) && (
            ...
            >
              ...
              <div className="text-center px-6 max-w-2xl">
                <h3 className="text-2xl font-bold mb-2 flex flex-row gap-2 items-center justify-center">
                    <svg width="45.5" height="33.5" viewBox="0 0 71 47" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <p className="text-lg text-gray-200 mb-4 max-w-[500px]">
